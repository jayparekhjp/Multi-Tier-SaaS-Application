...
app.get('/users/ping',function(req,res){
    ...
    client.get("http://goapi-test-1107158279.us-west-1.elb.amazonaws.com:3000/api/ping", function (data, response) {
...
app.post('/users/loginSubmit',function(req,res){
    ...
    console.log(args);
    client.post("http://goapi-test-1107158279.us-west-1.elb.amazonaws.com:3000/api/users/login", args, function (data, response) {
        console.log(data);
        // res.send(data);
...
app.post('/users/signupSubmit',function(req,res){
    ...
    console.log(args);
    client.post("http://goapi-test-1107158279.us-west-1.elb.amazonaws.com:3000/api/users/signup", args, function (data, response) {
